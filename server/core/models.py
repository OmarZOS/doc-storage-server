...
class Bay(Base):
    ...
    Store_ref_id = Column(ForeignKey('Store.idStore'), index=True)
    Bay_ref_fr = Column(String(45))
    Bay_ref_ar = Column(String(45))

    Store_ref = relationship('Store')
...
class Cob(Base):
    ...
    bay_ref_id = Column(ForeignKey('Bay.idBay'), index=True)
    bay_ref = relationship('Bay')
...
class Shelf(Base):
    ...
    cob_ref_id = Column(ForeignKey('Cob.idCob'), index=True)

    cob_ref = relationship('Cob')
