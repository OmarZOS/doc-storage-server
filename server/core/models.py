...
# coding: utf-8
from sqlalchemy import BigInteger, Column, Date, Float, ForeignKey, Integer, LargeBinary, SmallInteger, String
...
class DocumentTypeBelonging(Base):
    ...
    document_type_age = Column(Integer)
...
class Rack(Base):
    ...
    idRack = Column(Integer, primary_key=True)
    Rack_ref_fr = Column(String(45))
    Rack_ref_ar = Column(String(45))
...
class Shelf(Base):
    ...
    Rack_ref_id = Column(ForeignKey('Rack.idRack'), index=True)

    Rack_ref = relationship('Rack')
