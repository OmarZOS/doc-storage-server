...
class Container(Base):
    ...
    idContainer = Column(Integer, primary_key=True,autoincrement=True)
...
class DocumentType(Base):
    ...
    idDocument_type = Column(Integer, primary_key=True,autoincrement=True)
...
class DomainOrganisation(Base):
    ...
    idDomain_Organisation = Column(Integer, primary_key=True,autoincrement=True)
...
class Store(Base):
    ...
    idStore = Column(Integer, primary_key=True,autoincrement=True)
...
class Transcript(Base):
    ...
    idTranscript = Column(Integer, primary_key=True,autoincrement=True)
...
class ProfileRank(Base):
    ...
    idprofile_rank = Column(Integer, primary_key=True,autoincrement=True)
...
class Bay(Base):
    ...
    idBay = Column(Integer, primary_key=True,autoincrement=True)
...
class Elimination(Base):
    ...
    idElimination = Column(Integer, primary_key=True,autoincrement=True, nullable=False)
    max_eliminated_date = Column(Date)
    min_eliminated_date = Column(Date)
    id_transcript = Column(ForeignKey('Transcript.idTranscript'), primary_key=True,autoincrement=True, nullable=False, index=True)
    doc_type_ref = Column(ForeignKey('Document_type.idDocument_type'), primary_key=True,autoincrement=True, nullable=False, index=True)
...
class Sector(Base):
    ...
    idSector = Column(Integer, primary_key=True,autoincrement=True)
...
class DocumentTypeBelonging(Base):
    ...
    iddocument_type_belongings = Column(Integer, primary_key=True,autoincrement=True)
...
class Cob(Base):
    ...
    idCob = Column(Integer, primary_key=True,autoincrement=True)
...
class Organisation(Base):
    ...
    id_Organisation = Column(Integer, primary_key=True,autoincrement=True)
...
class CommunicationDemand(Base):
    ...
    idCommunication_demand = Column(Integer, primary_key=True,autoincrement=True)
...
class Profile(Base):
    ...
    idProfile = Column(Integer, primary_key=True,autoincrement=True)
...
class Shelf(Base):
    ...
    idShelf = Column(Integer, primary_key=True,autoincrement=True)
...
class Transfer(Base):
    ...
    idTransfer = Column(Integer, primary_key=True,autoincrement=True)
...
class CommunicationResponse(Base):
    ...
    idCommunication_response = Column(Integer, primary_key=True,autoincrement=True)
...
class ContainerPosition(Base):
    ...
    idContainer_position = Column(Integer, primary_key=True,autoincrement=True)
...
class Trainee(Base):
    ...
    idtrainee = Column(Integer, primary_key=True,autoincrement=True)
...
class ContainedType(Base):
    ...
    idContained_types = Column(Integer, primary_key=True,autoincrement=True)
...
class Document(Base):
    ...
    Doc_ID = Column(Integer, primary_key=True,autoincrement=True, nullable=False)
...
class TransferredContainedType(Base):
    ...
    idtransferred_contained_types = Column(Integer, primary_key=True,autoincrement=True)
...
class CommunicationSubject(Base):
    ...
    idCommunication_subject = Column(Integer, primary_key=True,autoincrement=True)
...
class DocumentChunk(Base):
    ...
    idChunk = Column(Integer, primary_key=True,autoincrement=True, nullable=False)
